...
def dynamics(prob, obj, section):
    ...
    Dr = (
        0.5 * rho * Vr * np.sqrt(Vr**2 + Vt**2) * obj.Cd[section] * obj.A[section]
    )  # [N]
    Dt = (
        0.5 * rho * Vt * np.sqrt(Vr**2 + Vt**2) * obj.Cd[section] * obj.A[section]
    )  # [N]
...
def inequality(prob, obj):
    ...
    rho = obj.air_density(R - obj.Re)
    Dr0 = 0.5 * rho * Vr * np.sqrt(Vr**2 + Vt**2) * obj.Cd[0] * obj.A[0]  # [N]
    Dt0 = 0.5 * rho * Vt * np.sqrt(Vr**2 + Vt**2) * obj.Cd[0] * obj.A[0]  # [N]
    Dr1 = 0.5 * rho * Vr * np.sqrt(Vr**2 + Vt**2) * obj.Cd[1] * obj.A[1]  # [N]
    Dt1 = 0.5 * rho * Vt * np.sqrt(Vr**2 + Vt**2) * obj.Cd[1] * obj.A[1]  # [N]
    g = obj.g0 * (obj.Re / R) ** 2  # [m/s2]
...
rho = obj.air_density(R - obj.Re)
Dr = 0.5 * rho * Vr * np.sqrt(Vr**2 + Vt**2) * obj.Cd[0] * obj.A[0]  # [N]
Dt = 0.5 * rho * Vt * np.sqrt(Vr**2 + Vt**2) * obj.Cd[0] * obj.A[0]  # [N]
g = obj.g0 * (obj.Re / R) ** 2  # [m/s2]
